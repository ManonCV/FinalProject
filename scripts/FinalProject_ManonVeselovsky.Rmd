...
m = glmer(roost ~ distance + sex + ordinal_date + sex:ordinal_date + moon.phase + (1|colony/id), data=depart_final_scaled, family="binomial",na.action=na.omit)

#requires scaling and centering
df.scale = standardize(depart_final,select=c("distance","ordinal_date"))
m = glmer(roost ~ distance + sex + ordinal_date + sex:ordinal_date + moon.phase + (1|colony/id), data=df.scale_nas, family="binomial",na.action=na.omit)
...
plot(dharm_output)
plotResiduals(dharm_output, form=df.scale_nas$distance)
plotResiduals(dharm_output, form=df.scale_nas$ordinal_date)
plotResiduals(dharm_output, form=df.scale_nas$sex)
plotResiduals(dharm_output, form=df.scale_nas$id)
plotResiduals(dharm_output, form=df.scale_nas$colony)
